...
# we need self monstruosity to make sure that literals are not treated as
# double precision, that slows down greatly floating-point execution.
# basically self static casts the constant to the type of the target
# pointer
@njit(fastmath=True, cache=True)
def cast(sph, lit):
    return lit  # static_cast<std.remove_pointer_t<decltype(sph)>>(lit)
...
@njit(fastmath=True, cache=True)
def COMPUTE_SPH_SECOND_DERIVATIVE_L0(
    sph_i,
    dxdx_sph_i,
    dxdy_sph_i,
    dxdz_sph_i,
    ...
    dxdx_sph_i[(0)] = dxdy_sph_i[(0)] = dxdz_sph_i[(0)] = 0.0
    dydx_sph_i[(0)] = dydy_sph_i[(0)] = dydz_sph_i[(0)] = 0.0
    dzdx_sph_i[(0)] = dzdy_sph_i[(0)] = dzdz_sph_i[(0)] = 0.0
...
@njit(fastmath=True, cache=True)
def COMPUTE_SPH_SECOND_DERIVATIVE_L1(
    sph_i,
    dxdx_sph_i,
    dxdy_sph_i,
    dxdz_sph_i,
...
def COMPUTE_SPH_DERIVATIVE_L2(
    ...
    dx_sph_i[(4)] = (2.23606797749979) * sph_i[(1)]
    dx_sph_i[(5)] = 0.0
    dx_sph_i[(6)] = -(1.29099444873581) * sph_i[(3)]
    dx_sph_i[(7)] = (2.23606797749979) * sph_i[(2)]
    dx_sph_i[(8)] = (2.23606797749979) * sph_i[(3)]

    dy_sph_i[(4)] = -(1.73205080756888) * dx_sph_i[(6)]
    dy_sph_i[(5)] = dx_sph_i[(7)]
    dy_sph_i[(6)] = -(0.577350269189626) * dx_sph_i[(4)]
    dy_sph_i[(7)] = 0.0
    dy_sph_i[(8)] = -dx_sph_i[(4)]

    dz_sph_i[(4)] = dz_sph_i[(8)] = 0.0
    dz_sph_i[(5)] = dx_sph_i[(4)]
    dz_sph_i[(6)] = (1.15470053837925) * dx_sph_i[(7)]
...
def COMPUTE_SPH_DERIVATIVE_L3(
    ...
    dx_sph_i[(13)] = (0.91409159892893) * (y2 - z2 + (4.75599275712721) * sph_i[(6)])
    dx_sph_i[(14)] = (2.64575131106459) * sph_i[(7)]
    dx_sph_i[(15)] = (3.24037034920393) * sph_i[(8)]

    dy_sph_i[(9)] = dx_sph_i[(15)]
    dy_sph_i[(10)] = dx_sph_i[(14)]
    dy_sph_i[(11)] = -(0.91409159892893) * (y2 - z2 - (1.58533091904240) * sph_i[(6)])
...
def COMPUTE_SPH_DERIVATIVE_L4(
    ...
    dx_sph_i[(21)] = -(1.338093087114578) * (
        z * z2
        - (2.745873698591307) * y * sph_i[(5)]
        - (4.019547514144073) * sph_i[(12)]
    )
    ...
    dy_sph_i[(19)] = -(1.338093087114578) * (
        z * (3 * y2 - z2) - (1.339849171381358) * sph_i[(12)]
    )
...
@njit(fastmath=True, cache=True)
def HARDCODED_SPH_SECOND_DERIVATIVE_MACRO(
    HARDCODED_LMAX,
    sph_i,
    dxdx_sph_i,
    dxdy_sph_i,
